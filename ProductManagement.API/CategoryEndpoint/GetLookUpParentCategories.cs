...
{
    [Authorize]
    public class GetLookUpParentCategories : EndpointWithoutRequest
    {
        private readonly GetLookUpParentCategoryHandler _handler;

        public GetLookUpParentCategories(GetLookUpParentCategoryHandler handler)
        {
            _handler = handler;
        }
        ...
        {
            Verbs(Http.GET);
            Routes("/api/categories/GetLookUpParentCategories");
        }
